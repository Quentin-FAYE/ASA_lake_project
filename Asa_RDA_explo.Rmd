...
#### reflexion sur les données manquante 
```{r}
# BCP de donnes manquante ? qu'est ce qu' on fait ? - on les retire dans une distribtuoion simmilaire
...
summary(bio_moyennes$Fish.catch..kg.gill.net.1.day.1.)
```
